...
public class Constantes {
    public static final String MENUPRINCIPAL = "Bienvenido a nuestro programa de gestión de películas, ¿qué deseas hacer?: ";
    ...
    public static final String OPCION1P = "1. Organizar Película";
    public static final String OPCION2P = "2. Cargar Película";
    ...
    public static final String MENULISTARESCENARIOS ="¿De qué forma deseas listar los escenarios?";
